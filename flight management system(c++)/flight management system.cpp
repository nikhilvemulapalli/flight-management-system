...
class Details
{
	public:
		...
		void information()
		{
			cout<<"\nEnter the customer ID (only digits) : ";
			cin>>cId;
			cout<<"\nEnter the name : ";
			cin>>name;
			cout<<"\nEnter the age : ";
			...
			case 1:
				{
					...
					cout<<"1.DUB - 498"<<endl;
					cout<<"\t 09-09-2023 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.DUB - 602"<<endl;
					cout<<"\t 09-09-2023 | 9:00 AM | 10 HRS | Rs.9000"<<endl;
					cout<<"3.DUB - 204"<<endl;
					cout<<"\t 09-09-2023 | 2:00 PM | 11 HRS | Rs.10000"<<endl;
					cout<<"Choose the timings and dates (only coloum no) : ";
					cin>>choice1;
					if(choice1==1)
					{
						charges=7500;
